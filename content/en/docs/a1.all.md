...
<table style="width:100%">
  ...
  {{ range $.Site.Data.sites }}
  <tr>
    <td markdown="span">{{ .company }}</td>
    <td markdown="span">{{ .category }}</td>
    <td markdown="span">{{ site.url }}</td>
    <td markdown="span">{{ .description }}</td>
    <td markdown="span">{{ .dark_mode }}</td>
    <td markdown="span">{{ .mode_configurable }}</td>
    <td markdown="span">{{ .default_theme_style }}</td>
    <td markdown="span">{{ .supports_custom_themes }}</td>
    <td markdown="span">{{ .contrast_accessibility }}</td>
    <td markdown="span">{{ .accessibility_rating }}</td>
    <td markdown="span">{{ .last_updates }}</td>
  </tr>
  {{ end }}
</table>